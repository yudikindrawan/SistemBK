        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                @else
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="pages-elements.html" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">Data Pelanggaran</span></a></li>
